...
/* in your implementation's top-level include file (e.g. real\coder.h) you
 * should add new #define sym STATNAME(sym) lines for all the additional global
 * functions or variables which your implementation uses
 */
